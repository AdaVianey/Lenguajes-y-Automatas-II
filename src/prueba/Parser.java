...
public class Parser {
    ...
    public void term() throws IOException {
        if (Character.isDigit((char) this.lookahead)) {
        	...
        	System.out.println("Se esperaba un DIGITO , se obtuvo: "+Character.getNumericValue(lookahead));
    ...
    public void match(int ch) throws IOException {
        if (lookahead == ch) {
        	...
        	System.out.println("M Se esperaba un OTRA COSA , se obtuvo: "+Character.getNumericValue(lookahead));
            throw new Error("Syntax Error");
        }
    }
}